...
$(function () {
  ...
  /* === 2. Real-time search + suggestions + highlight (about.html) === */
  ...
  /* === 3. Animated number counters (index.html) === */
  $(".count").each(function(){
    const $n = $(this);
  ...
  /* === 4. Copy to clipboard (index.html) === */
  ...
  /* === 5. Contact form spinner (contacts.html) === */
